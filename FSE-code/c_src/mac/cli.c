...
const char* cli_info_purpose = "FileSystem macOS file system watcher using FSEvents API";
const char* cli_info_usage = "Usage: mac_listener [OPTIONS]... [PATHS]...";
...
{
  printf("FileSystem macOS Watcher v2.0.0\n");
  printf("Created by mehdi\n\n");
}
