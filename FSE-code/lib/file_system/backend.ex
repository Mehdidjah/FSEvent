...
defmodule FileSystem.Backend do
  @moduledoc """
  Behaviour module for implementing platform-specific file system backends.

  This module defines the interface that all file system backends must implement.
  It also provides automatic backend selection based on the operating system
  and validation of backend implementations.

  ## Backend Selection

  The module automatically selects the appropriate backend based on the OS:
  - macOS: `FileSystem.Backends.FSMac` (uses FSEvents)
  - Linux/FreeBSD: `FileSystem.Backends.FSInotify` (uses inotify)
  ...
  `supported_systems/0` are defined.
  """
