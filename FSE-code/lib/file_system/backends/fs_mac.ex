...
defmodule FileSystem.Backends.FSMac do
  @moduledoc """
  File system backend for macOS using FSEvents API.

  This backend uses the native macOS FSEvents framework to monitor file system changes.
  The built-in executable file is compiled automatically upon first use.

  ## How It Works

  The backend spawns a native macOS executable that uses the FSEvents API to monitor
  ...
  ## Backend Options
    ...
    * recursive is enabled by default and cannot be disabled.
