defmodule FileSystem.MixProject do
  ...
  @source_url "https://github.com/Mehdidjah"
  @version "2.0.0"
  ...
  defp description do
    """
    A modern Elixir file system change watcher with advanced features including
    filtering, throttling, deduplication, debouncing, batching, and telemetry support.
